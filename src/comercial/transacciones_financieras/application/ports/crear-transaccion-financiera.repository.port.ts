...
export abstract class TransaccionFinancieraRepositoryPort {
  abstract save(transaccion: TransaccionFinanciera): Promise<TransaccionFinanciera>;
  ...
  abstract update(id: number, transaccion: Partial<TransaccionFinanciera>): Promise<TransaccionFinanciera>;
