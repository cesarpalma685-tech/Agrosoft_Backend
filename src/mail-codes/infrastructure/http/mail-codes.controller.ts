...
import { CreateEmailCodeDto } from './dto/create-mail-codes.dto';
import { UpdateEmailCodeDto } from './dto/update-mail-codes.dto';
...
@Patch(':id')
actualizar( @Param('id', ParseIntPipe) id: number,
