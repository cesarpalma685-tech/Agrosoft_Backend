...
export class MovimientoInsumoOrmEntity {
  ...
  @Column({ name: 'costoUnitarioPresentacion', type: 'double precision', nullable: true })
  costoUnitarioPresentacion?: number;

  @Column({ name: 'costoUnitarioUso', type: 'double precision', nullable: true })
  costoUnitarioUso?: number;

  @Column({ name: 'costoTotal', type: 'double precision', nullable: true })
  costoTotal?: number;

  @Column({ name: 'valorInventarioResultante', type: 'double precision', nullable: true })
